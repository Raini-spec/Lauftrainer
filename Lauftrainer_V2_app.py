...
if "run_status_update" not in st.session_state: st.session_state.run_update_status = False
if "run_plan_update" not in st.session_state: st.session_state.run_update_plan = False    
...
# ==============================================================================
    ...
    if st.session_state.ansicht == "Wochenplan":
        ...
        # Zwei Spalten für die beiden Buttons nebeneinander
            ...
            # ==========================================================
            if st.session_state.get("run_update_status"):
                if load_and_format_strava_data():
                    try:
                        with st.spinner("Berechne Leistungsstatus..."):
                            ...
                            ===STATUS_END===
                            """
                            text = ask_gemini_with_retry(client, prompt_master, st.session_state.doc_images)
